...
@RunAsClient
public class UserResourceCreateApproverUserJSONTest extends BaseResourceTest
{
    ...
    public void testCreateUserAsJSON()
        throws Exception
    {
        runJSONPostTest(USER_RESOURCE_PREFIX, "/", "json/User_createApproverUser_request.json", "json/User_createApproverUser_response.json") ;
        ...
        runJSONGetTest(USER_RESOURCE_PREFIX, "/", queryParams, "json/User_createApproverUser_getUsers_response.json") ;
    }
}
